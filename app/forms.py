...
class CandidateForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'departure_date': forms.DateInput(attrs={'type':'date', 'class': 'form-control', 'placeholder': 'Enter the username'}),
            ...
            'scheduled_on': forms.DateInput(attrs={'type':'date', 'class': 'form-control', 'placeholder': 'Enter the username'}),
